...
`ggseg` also allows us to visualize subcortial structures.
...
A sister package related to `ggseg`, called `ggseg3d` allows us to visualise our ROI level data in interactive 3D. We will briefly go though some of the basic functionality. 
